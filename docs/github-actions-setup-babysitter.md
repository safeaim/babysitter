...
The action builds `agent-platform` from the action repository. If it fails, check Node.js availability:
...
- [Babysitter Agent Runtime](https://github.com/a5c-ai/babysitter/tree/main/packages/agent-platform)
