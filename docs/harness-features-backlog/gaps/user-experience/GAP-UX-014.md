...
## Current State
Modes implied by wrapper choice (`agent-platform plan`, `agent-platform yolo`, `agent-platform forever`). Not selectable in-session. Changing mode requires starting a new run.
