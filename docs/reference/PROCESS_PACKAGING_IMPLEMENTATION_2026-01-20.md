...
- The Babysitter plugin package provides skill instructions and plugin behavior under `plugins/babysitter/`.
...
The plugin package lives under `plugins/babysitter/`. It provides:

- `plugins/babysitter/skills/babysit/SKILL.md`
- plugin metadata and installation behavior
- references and hook-related assets

The plugin does not currently ship the full process tree inside `plugins/babysitter/skills/babysit/`.
...
2. Treat `plugins/babysitter/skills/babysit/SKILL.md` as the skill entry point, not the process library root.
