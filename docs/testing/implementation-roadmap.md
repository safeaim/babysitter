...
| 2. SDK harness/plugin setup smoke | Planned | SDK and harness maintainers | No-model | `harness:install --dry-run`, `harness:install-plugin --dry-run`, and plugin discovery produce JSON evidence without claiming agent-platform runtime coverage | PR/push CI |
