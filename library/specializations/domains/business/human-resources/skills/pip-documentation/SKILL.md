...
description: Create legally compliant performance improvement plan documentation with evidence tracking and milestone management
allowed-tools:
  - Read
  - Write
  - Glob
...
1. **Generate PIP Templates with Required Elements**
...
2. **Document Performance Deficiencies with Evidence**
...
3. **Create SMART Improvement Goals**
...
4. **Build Support and Resource Plans**
...
5. **Track PIP Milestones and Check-ins**
...
6. **Generate Outcome Determination Documentation**
...
7. **Ensure Legal Compliance and Consistency**
