...
export async function process(inputs, ctx) {
  ...
  let predictiveAnalysis = await ctx.task(predictiveFailureTask, { vehicles, sensorData, maintenanceHistory, outputDir });
  ...
  let maintenanceReport = await ctx.task(maintenanceReportTask, { healthAssessment, predictiveAnalysis, preventiveScheduling, costForecast, uptimeOptimization, outputDir });
