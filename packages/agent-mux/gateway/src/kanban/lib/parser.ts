...
export async function parseTaskDetail(
  ...
  let breakpointPayload: import("../types/index.js").BreakpointPayload | undefined;
  if (kind === "breakpoint" && resolvedInput) {
    breakpointPayload = {
      ...
      context: resolvedInput.context as import("../types/index.js").BreakpointPayload["context"],
    };
  }
