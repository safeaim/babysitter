  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        '(imported from @a5c-ai/agent-comm-mux) so it gets cleaned up on uncaught exceptions.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Import from @a5c-ai/agent-comm-mux: PROVIDER_DEFAULTS, MODEL_TRANSLATION_TABLE.',
        '',
