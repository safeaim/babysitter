# hooks-proxy Architecture

## 1. System Overview

`hooks-proxy` is a hooks normalization and context-propagation runtime. It sits between native harness hook invocations (Claude Code, Codex, Gemini, Copilot, Cursor, Pi, oh-my-pi, OpenCode, OpenClaw) and the handlers that act on them.
