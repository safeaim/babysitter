...
/**
 * Parse the JSON output from a5c-hooks-proxy invoke stdout.
 * Used by SDK harness adapters to consume hooks-proxy results.
 *
...
/**
 * Parse a hooks-proxy normalized event (e.g., from a file or pipe).
 *
 * @throws {HookOutputParseError} on malformed JSON or missing required fields.
 */
