...
```bash
a5c-hooks-proxy invoke --adapter claude --bootstrap-only
```

or

```bash
a5c-hooks-proxy bootstrap --adapter claude
```
...
```bash
a5c-hooks-proxy bootstrap --adapter <adapter>
```
