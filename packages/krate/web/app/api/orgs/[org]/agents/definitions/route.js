...
export const GET = withAuth((request, { params }) => listIdentityResources(request, params, 'AgentDefinition'));
...
export const POST = withAuth((request, { params }) => {
  ...
  return createIdentityResource(request, params, 'AgentDefinition');
});
