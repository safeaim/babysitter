...
const targets = [
  {
    id: 'claude',
    repo: 'a5c-ai/babysitter-claude',
    sourceDir: 'generated/claude-code',
    packageName: null,
    marketplaces: [{ from: 'generated/.claude-plugin/marketplace.json', to: '.claude-plugin/marketplace.json', kind: 'claude' }],
  },
  {
    id: 'codex',
    repo: 'a5c-ai/babysitter-codex',
    sourceDir: 'generated/codex',
    packageName: '@a5c-ai/babysitter-codex',
    marketplaces: [{ from: 'generated/.agents/plugins/marketplace.json', to: '.agents/plugins/marketplace.json', kind: 'codex' }],
  },
  { id: 'gemini', repo: 'a5c-ai/babysitter-gemini', sourceDir: 'generated/gemini', packageName: '@a5c-ai/babysitter-gemini', marketplaces: [] },
  { id: 'cursor', repo: 'a5c-ai/babysitter-cursor', sourceDir: 'generated/cursor', packageName: '@a5c-ai/babysitter-cursor', marketplaces: [] },
  { id: 'github-copilot', repo: 'a5c-ai/babysitter-github-copilot', sourceDir: 'generated/github-copilot', packageName: '@a5c-ai/babysitter-github', marketplaces: [] },
  { id: 'omp', repo: 'a5c-ai/babysitter-omp', sourceDir: 'generated/oh-my-pi', packageName: '@a5c-ai/babysitter-omp', marketplaces: [] },
